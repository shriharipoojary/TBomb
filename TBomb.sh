#!/bin/bash
clear
echo -e "\e[4;31m Shrihari Productions !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m TBomb \e[0m"
echo "Press Enter To Continue"
read a1
if [[ -s update.shrihari ]];then
...
echo This Script Was Made By Shrihari >update.shrihari
...
toilet -f mono12 -F border Shrihari
echo -e "\e[4;34m This Bomber Was Created By Shrihari \e[0m"
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By Shrihari'> call.xxx
...
git clone https://github.com/TheShrihari/TBomb
if [[ -s TBomb/TBomb.sh ]];then
cd TBomb
cp -r -f * .. > temp
cd ..
rm -rf  TBomb >> temp
rm update.shrihari >> temp
rm temp
chmod +x TBomb.sh
fi
...
echo -e "\e[1;33m      [*]  Shrihari   \e[1;31m"
...
echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
echo -e "\e[1;32m           Mail: shriharipoojary9921@gmail.com \e[0m"
echo -e "\e[1;32m       Whatsapp: https://bit.do/shriharigit \e[0m"
